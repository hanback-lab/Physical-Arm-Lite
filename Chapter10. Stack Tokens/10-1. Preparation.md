...
이번 장에선 토큰 두 개를 이용해 탑을 쌓는 훈련을 진행하겠습니다.
...
POLICY_REPO_ID = "<id>/stack_tokens"
DATASET_REPO_ID = "<id>/stack_tokens_dataset"

STATS_CACHE_PATH = (
    "/home/soda/physicai_arm_ws/src/physicai_arm/physicai_arm/dataset_stats_stacking.json"
)
