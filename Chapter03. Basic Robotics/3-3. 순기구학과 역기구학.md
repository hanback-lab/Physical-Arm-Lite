...
IK에는 항상 해가 있는 것이 아니며 workspace의 제한이 있다는 점을 유의하며 실습을 진행해 보겠습니다. 최대 도달 거리와 최소 도달 거리를 알아보고 목표점 거리가 이 범위 안에 있어야 IK 해가 존재한다는 점을 알아보겠습니다.
...
4. 2-link 로봇 l1=2, l2=2 이 있을 때, 목표점이 (2,2)이면 가능한 IK 해는 몇 개인가?
