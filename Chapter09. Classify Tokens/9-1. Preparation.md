...
8장에 이어 조금 더 복잡해진 행동을 학습해보겠습니다. 단순히 빨간 토큰만 집어 박스에 넣는 것이 아니라, 빨간 토큰은 왼쪽 박스, 초록 토큰은 오른쪽 박스로 분류해서 넣도록 훈련하겠습니다.
...
class LoggerNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("save_dir", "dataset_raw_classify")
...
POLICY_REPO_ID = "<id>/classify_tokens"
DATASET_REPO_ID = "<id>/classify_tokens_dataset"

STATS_CACHE_PATH = (
    "/home/soda/physicai_arm_ws/src/physicai_arm/physicai_arm/dataset_stats_classification.json"
)
...
class InferenceNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(
            f"InferenceNode started. fps={self.fps}, device={self.device}"
        )
