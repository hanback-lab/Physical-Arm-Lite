...
장비에 탑재된 온보드엔 이미 VSCode가 설치되어져 있습니다. 아래 사진과 같이 좌측 바에 실행 링크가 위치하여져 있습니다. 또한, 새 터미널을 연 뒤 'code' 라는 명령어를 입력하여 VSCode를 실행할 수 있습니다.
...
본 챕터에서는 파이썬 코드 자동 완성, 디버깅 등의 파이썬 개발에 편리한 기능을 주는 Extension 을 설치해봅니다. 아래 사진과 같이 VSCode 좌측의 Extension 아이콘 버튼을 누른 뒤, 검색 창에 'python' 이라고 입력하여 주십시오. 그 후 Python 항목에 배치된 'install' 버튼을 클릭합니다.
