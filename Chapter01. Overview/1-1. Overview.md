...
본 챕터에서는 파이썬 코드 자동 완성, 디버깅 등의 파이썬 개발에 편리한 기능을 주는 Extension을 설치해 보겠습니다. 아래 사진과 같이 VSCode 좌측의 Extension 아이콘 버튼을 누른 뒤, 검색 창에 'python'이라고 입력해 주시기 바랍니다. 그 후 Python 항목에 배치된 'Install' 버튼을 클릭합니다.
