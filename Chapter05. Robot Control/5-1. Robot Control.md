...
제어 패키지 다운로드 및 실행은 [4장의 4.1. Robot Modeling](/Chapter04.%20Robot%20Modeling/4-1.%20Robot%20Modeling.md#연습-과제-:-PhysicAI-Arm-로봇-모델을-RViz2에-출력하기)을 참고해 주시기 바랍니다. 모든 실습은 `bringup.launch.py`를 실행한 뒤 진행합니다.
