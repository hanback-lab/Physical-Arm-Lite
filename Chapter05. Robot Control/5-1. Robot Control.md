...
따라서 조작기의 일종인 조이스틱을 활용해 로봇을 제어합니다. `bringup.launch.py`, `joystick.launch.py` 런치 파일을 실행하면 조이스틱을 이용해 매니퓰레이터를 제어할 수 있습니다.

조이스틱 제어 방법은 [1-1. Overview](/Chapter01.%20Overview/1-1.%20Overview.md#Follower-Arm)를 참고해주시기 바랍니다.
