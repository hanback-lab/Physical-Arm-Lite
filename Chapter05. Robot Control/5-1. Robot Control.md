...
제어 패키지 다운로드 및 실행은 [4장의 4.1. Robot Modeling](/Chapter04.%20Robot%20Modeling/4-1.%20Robot%20Modeling.md#연습-과제-:-Physical-Arm-Lite-로봇-모델을-RViz2에-출력하기)을 참고해 주시기 바랍니다. 모든 실습은 bringup 런치 파일을 실행한 뒤 진행합니다.
...
따라서 조작기의 일종인 조이스틱을 활용해 로봇을 제어합니다. `bringup.launch.py` 런치 파일을 실행하면 조이스틱을 이용해 매니퓰레이터를 제어할 수 있습니다.
