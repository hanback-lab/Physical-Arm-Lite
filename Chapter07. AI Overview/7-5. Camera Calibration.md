...
[이미지 다운로드](https://github.com/hanback-lab/PhysicAI-Arm/blob/main/Chapter07.%20AI%20Overview/pds/checkerboard9x7.png)
...
OUTPUT_PATH = "/home/soda/physicai_arm_ws/src/physicai_arm/physicai_arm/calibration.json"
...
class TopCamCalibrationNode(Node):
    ...
    def calibrate(self):
        ...
        if self.latest_frame is not None:
            cv2.imwrite("before_cali.jpg", self.latest_frame)
            dst = cv2.undistort(self.latest_frame, mtx, dist, None, newcameramtx)
