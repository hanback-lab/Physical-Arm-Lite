...
이제 PhysicAI Arm Camera를 사용해 실제 캘리브레이션 작업을 진행해 보겠습니다. 카메라 캘리브레이션은 Python, OpenCV를 활용하여 진행합니다. 해당 패키지 관련 자세한 정보는 아래 사이트를 참고해 주시기 바랍니다. PhysicAI Arm에는 이미 설치되어 있으므로 따로 준비할 필요는 없습니다.
...
12. 캘리브레이션 결과를 JSON파일로 저장해 두면 다음 실습에서 어떻게 활용할 수 있는가?
