...
Gazebo란 로봇 공학에서 3D 환경 속 로봇, 센서, 물체 등을 실제와 유사한 물리 엔진으로 시뮬레이션하는 오픈 소스 도구입니다. ROS2와 연동성이 매우 높으며 로봇팔을 비롯한 자율주행, 제어 알고리즘 등을 안전하게 테스트하고 검증하는 데 사용됩니다.
